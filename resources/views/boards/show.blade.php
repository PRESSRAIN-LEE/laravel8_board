		...
		<div class="row">
			<div class="col-12 border border-1 mt-5">
				...
				<div class="d-grid gap-2 d-md-flex justify-content-md-end mb-3">
					<a href='{{ route('boards.index') }}' class="btn btn-primary me-md-2">목록</a>
					<a href='{{url('/')}}/boards/{{$board -> id}}/edit' class="btn btn-secondary me-md-2">수정</a>
					<a href='{{url('/')}}/boards/{{$board -> id}}/reply' class="btn btn-warning me-md-2">답변</a>
